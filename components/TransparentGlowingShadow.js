...
export function TransparentGlowingShadow({ children }) {
  ...
  return (
    <>
      <style jsx>{`
        ...
        .transparent-glow-container:before,
        .transparent-glow-container:after {
          content: "";
          display: block;
          position: absolute;
          width: 100%;
        ...
        .transparent-glow-content:before {
          content: "";
          display: block;
          position: absolute;
        ...
        .transparent-glow-container:hover .transparent-glow-content {
        ...
        .transparent-glow-container:hover .transparent-glow-content:before {
          --bg-size: 15;
          animation-play-state: paused;
          transition: --bg-size var(--interaction-speed) ease;
        }

        .transparent-glow-container:hover .transparent-glow {
          --glow-blur: 1.5;
          --glow-opacity: 0.6;
          --glow-scale: 2.5;
          --glow-radius: 0;
        ...
        .transparent-glow-container:hover .transparent-glow:after {
          --glow-translate-y: 0;
          animation-play-state: paused;
      ...
      <div className="transparent-glow-container" role="button">
        <span className="transparent-glow"></span>
        <div className="transparent-glow-content">{children}</div>
      </div>
    </>
  )
}
